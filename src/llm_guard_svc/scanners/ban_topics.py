...
def _import_lib_class() -> Any:
    from llm_guard.input_scanners import BanTopics as _BanTopicsLib  # type: ignore[import-untyped]
...
_: Scanner = BanTopicsScanner.__new__(BanTopicsScanner)  # structural conformance check
